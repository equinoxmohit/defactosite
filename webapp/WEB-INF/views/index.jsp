    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 intro-pic wow slideInLeft">
                <img src="https://dummyimage.com/1000x556/bcbcbc/0e0e0f" alt="image" class="img-responsive">
            </div>
            ...
            <div class="col-md-6 wow slideInRight">
                ...
                <div class="btn-section"><a href="<c:url value="/products"></c:url> " class="btn-default">View Products</a></div>
